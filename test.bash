...
printf "\n"
echo " ➡ svelte build size:       ${svelte_build_size} bytes"
echo " ➡ svelte_kit build size:   ${svelte_kit_build_size} bytes"
echo " ➡ react build size:        ${react_build_size} bytes"
echo " ➡ react_next build size:   ${react_next_build_size} bytes"
